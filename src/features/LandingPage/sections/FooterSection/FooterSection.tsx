    ...
    export const FooterSection = (): JSX.Element => {
      return (
        <div className="absolute top-[6564px] left-0 w-[1537px] h-[100px] flex bg-[url(https://c.animaapp.com/mn52tbe7U6Iu7j/img/footer-section.png)] bg-[100%_100%]">
          {/* <footer className="w-[1351.91px] ml-[97.0px] flex items-end bg-transparent"> */}
            <div className="ml-[97.0px] mb-0 w-[1351.91px] ml-0 flex">
              <div className="mt-0 w-[1351.91px] h-[30px] ml-0 flex flex-col gap-[33px]">
                <img
                ...
                <div className="w-[1338px] h-[20px] items-start gap-[68px] inline-flex relative ">
