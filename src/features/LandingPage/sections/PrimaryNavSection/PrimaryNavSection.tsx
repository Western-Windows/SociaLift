      ...
      <div className="absolute top-0 left-0 w-[1536px] h-[72px] flex items-center justify-end">
        <div className="inline-flex h-[52px] mr-6 w-[308px] relative items-center justify-center gap-4">
          ...
          <button 
            ...
            className="all-[unset] box-border relative w-[146px] h-[52px] rounded-lg overflow-hidden border border-solid border-[#07265c] cursor-pointer"
          >
          ...
          <button 
            ...
            className="all-[unset] box-border relative w-[146px] h-[52px] bg-[#07265c] rounded-lg overflow-hidden border border-solid cursor-pointer"
          >
