                ...
                <section className="gs-form-card">
                    ...
                    <div className="gs-results">
                        <div className="gs-result-item">
                            ...
                            <span className="gs-result-value">The Trusted Curator (Classic & Reliable)</span>
                        </div>

                        <div className="gs-result-item">
                            <span className="gs-result-label">Persona's Tone:</span>
                            <span className="gs-result-value">Authoritative, warm, and polished.</span>
                        </div>

                        <div className="gs-result-item">
                            <span className="gs-result-label">Example Post Generated By This Persona:</span>
                            <span className="gs-result-value">
                                Quality you can trust for the people who matter most. From Nike active wear to Gini & Jony play-ready outfits, we've curated a complete wardrobe solution for your modern family since 1998.
                            </span>
                        </div>
                    </div>
